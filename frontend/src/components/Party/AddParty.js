...
export default function AddParty({ setShowAdd, token, setParties, weddingId }) {
  ...
  return (
    ...
    <form className="mt-3 bg-slate-200/90 p-2 rounded-lg shadow-xl z-10" id="addParty" onSubmit={formSubmit}>
    <div className="h-6 w-6 float-right relative py-0 z-10 hover:text-red"><XMarkIcon className="hover:text-red-500"  onClick={()=>setShowAdd(false)}/></div>
      <div className="form-floating mt-6 mb-3 xl:w-96">
        <input
          ...
          required
          />
        <label className="text-gray-700 dark:text-slate-300" htmlFor="partyName">
          Party Name*
        </label>
      </div>
      <div className="mb-3">
      ...
      <div className="form-floating mb-3">
        <input
          ...
          />
        <label className="text-gray-700 dark:text-slate-300" htmlFor="street1">
      ...
      <div className="form-floating mb-3">
        <input
          ...
          />
        <label className="text-gray-700 dark:text-slate-300" htmlFor="street2">
      ...
      <div className="form-floating mb-3">
        <input
          ...
          />
        <label className="text-gray-700 dark:text-slate-300" htmlFor="zipcode">
          Zip Code
        </label>
      </div>
      <div className="form-floating mb-3">
        <input
          ...
          placeholder="Country"
          />
        <label className="text-gray-700 dark:text-slate-300" htmlFor="country">
          Country
        </label>
      </div>
